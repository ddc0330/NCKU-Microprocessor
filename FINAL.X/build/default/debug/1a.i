...
# 347 "1a.c"
    ...
    while (1) {
        ...
        if(mode == 1){
            set_LED_separately(1, 0, 0);
            _delay((unsigned long)((0.25 * 1000)*(4000000/4000.0)));;
            if(mode!=1){
                continue;
            }
            set_LED_separately(0, 1, 0);
            _delay((unsigned long)((0.25 * 1000)*(4000000/4000.0)));;
            if(mode!=1){
                continue;
            }
            set_LED_separately(0, 0, 1);
            _delay((unsigned long)((0.25 * 1000)*(4000000/4000.0)));;
            if(mode!=1){
                continue;
            }
            ...
            set_LED_separately(1, 0, 0);
            _delay((unsigned long)((0.5 * 1000)*(4000000/4000.0)));;
            if(mode!=2){
                continue;
            }
            set_LED_separately(0, 1, 0);
