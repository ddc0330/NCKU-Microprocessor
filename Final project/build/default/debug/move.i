...
void __attribute__((picinterrupt(("high_priority")))) ISR(void)
{
    ...
    {
        LATD=0;
        _delay((unsigned long)((10.5 * 1000)*(125000/4000.0)));;
        for(int i=0;i<x;i++){
            setServoPosition2(56);
            _delay((unsigned long)((0.18 * 1000)*(125000/4000.0)));;
        }
        setServoPosition2(46);
        x=0;
        for(int i=0;i<y;i++){
            setServoPosition1(36);
            _delay((unsigned long)((0.179 * 1000)*(125000/4000.0)));;
        }
        ...
        _delay((unsigned long)((5)*(125000/4000.0)));
        if(i==0){
            i=1;
                if(value > 800){
                    setServoPosition2(36);
                    _delay((unsigned long)((0.15 * 1000)*(125000/4000.0)));;
                    x++;
                }
                else if(value < 200){
                    setServoPosition2(56);
                    _delay((unsigned long)((0.169 * 1000)*(125000/4000.0)));;
                    x--;
                }
                else{
                    setServoPosition2(46);
            ...
            i=0;
                if(value >800){
                    ...
                    setServoPosition1(36);
                    _delay((unsigned long)((0.16 * 1000)*(125000/4000.0)));;
                    y--;
                }else{
                    setServoPosition1(46);
                }
