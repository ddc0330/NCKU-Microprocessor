...
int i=0,prex=0,prey=0,directionx=0,directiony=0;
int distance_x=0,distance_y=0;
int timex=0,timexx=0;
int press=0;
void __attribute__((picinterrupt(("")))) ISR(void)
{
    ...
    if (PIR1bits.ADIF && press==0) {
        ...
        if(i==0){
            ...
            i=0;
                if(value >800&&distance_y<30){
                    setServoPosition1(52);
                    _delay((unsigned long)((0.1 * 1000)*(125000/4000.0)));;
                    distance_y++;
                }else if(value <200&&distance_y>0){
                    setServoPosition1(40);
                    _delay((unsigned long)((0.1 * 1000)*(125000/4000.0)));;
                    distance_y--;
                }else{
